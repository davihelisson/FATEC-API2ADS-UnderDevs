...
public class Prompts {
    ...
    public String generateCode() throws Exception {
        ...
        PromptBuilder promptBuilder = new PromptBuilder()
                ...
                .addLine("- DO NOT add any comments in the code.")
                .addLine("- NEVER add text that is not related to the code like comments or explanations.")
    ...
    public String improveCode() throws Exception {
        PromptBuilder promptBuilder = new PromptBuilder()
                ...
                .addLine("- DO NOT exclude or change any previous comments in the code.")
                .addLine("- DO NOT add any comments in the code.")
                .addLine("- DO add text that is not related to the code like comments or explanations about the code.")
